...
fun ListAddDialog(
    onOk: (String) -> Unit,
    onDismiss: () -> Unit,
    buffer: MutableMap<String, Boolean>
) {
    ...
    AlertDialog(
        ...
        text = {
            Column {
                val isError = newItemText.isEmpty() || buffer.containsKey(newItemText)
                        ...
                        if (isError) {
                            Text(
                                ...
                                text = when {
                                    ...
                                    buffer.containsKey(newItemText) -> "Cet élément existe déjà"
                                    else -> ""
                                },
        ...
        confirmButton = {
            Row(
                ...
                CustomButton(
                    ...
                    enabled = newItemText.isNotEmpty() && !(buffer.containsKey(newItemText))
                )
            }
        }
    )
